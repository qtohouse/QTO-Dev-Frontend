...
const Footer = () => {
    ...
    const Services = [
      ...
      const LogoContent = {
        ...
        Content:'At QTO Dev, our talented team of designers, developers, and marketers is dedicated to realizing your vision. We provide website development, custom branding, and marketing solutions to connect with your audience.'
      }

      const NewsletterContent = {
            Content:'Stay in the loop with the latest updates and special offers from QTO Dev.'
      } 

      const AdressContent = {
        Title:'Innovative User Experience',
        Number:'+1 312-544-0023'
      }
                    ...
                    <div className="row copyright">
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="-copyright-text">
                                <p>© 2024 QTO Dev - ALL RIGHTS RESERVED</p>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="copyright-list">
                                <ul>
                                    ...
                                    <li><Link to="/home3">Supports</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
